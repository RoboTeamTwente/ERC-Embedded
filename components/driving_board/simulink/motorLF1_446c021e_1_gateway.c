...
void motorLF1_446c021e_1_gateway(void)
{
  NeModelParameters modelparams = { (enum NeSolverTypeTag)0, 0.001, 0.001, 0.001,
    ...
    enum SscLoggingSettingTag)0, 689600899.0, TRUE, FALSE, FALSE };
  ...
  NeSolverParameters solverparams = { TRUE, TRUE, FALSE, FALSE, FALSE, FALSE,
    ...
    NeLocalSolverChoiceTag)1, TRUE, 1U, 0.001, FALSE, 3U, 2U, FALSE, 2U, (enum
  ...
  motorLF1_446c021e_49_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("motorLF1/motorLF1/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
