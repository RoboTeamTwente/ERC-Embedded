...
/* ---- New drivers -------------------------------------------------------- */
#include "components/sensor_board/flow_sensor/flow_sensor.h"
#include "components/sensor_board/pump/pump.h"
...
#include "components/sensor_board/sampling/flow_sensor.pb.h"   /* SensorBoardFlowSensorInfo */
#include "components/sensor_board/sampling/pump.pb.h"           /* SensorBoardPumpInfo      */
