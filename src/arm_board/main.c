...
int main(void) {
    ...
    /* IMPORTANT: Enable DMA controller clock and configure DMA for TIM2_CH1 */
    /* This function is generated by CubeMX when you configure DMA. */
    MX_DMA_Init();
...
void test_stepper(void* argument) {
    ...
    // Call a simple function to generate a continuous PWM for testing.
    // This will allow you to easily verify the signal on the oscilloscope.
    test_generate_pwm(&step);
